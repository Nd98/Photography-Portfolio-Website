(function(){
	...
	$.fn.tzShutter = function(options){
		...
		window.setTimeout(function(){
			...
			var frames = {num:15, height:3000, width:2000},
				slices = {num:8, width: 1000, height:1200, startDeg:30},
				animation = {
					width : element.width(),
			...
			img.onload = function(){
				...
				for(var z=0;z<frames.num;z++){
					...
					for(var i=0;i<slices.num;i++){
						...
						c.drawImage(img,-slices.width/2,-(frames.height/2 + offset),1000,1200);
